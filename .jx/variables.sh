...
export JENKINS_X_URL='https://dashboard-jx.infra.jenkins-x.rocks/jenkins-x-plugins/jx-charter/main/1'
...
export MINK_IMAGE='ghcr.io/jenkins-x/jx-charter:0.0.29'
