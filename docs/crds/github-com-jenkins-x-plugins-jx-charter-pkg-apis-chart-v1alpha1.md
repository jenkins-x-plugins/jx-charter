# Package github.com/jenkins-x-plugins/jx-charter/pkg/apis/chart/v1alpha1
...
| `spec` | [ChartSpec](./github-com-jenkins-x-plugins-jx-charter-pkg-apis-chart-v1alpha1.md#ChartSpec) | No |  |
| `status` | *[ChartStatus](./github-com-jenkins-x-plugins-jx-charter-pkg-apis-chart-v1alpha1.md#ChartStatus) | No |  |
...
| Stanza | Type | Required | Description |
|---|---|---|---|
| `repositoryName` | string | No | RepositoryName the chart repository name used in the fully qualified chart name |
| `repositoryUrl` | string | No | RepositoryURL the chart repository URL |
...
| Stanza | Type | Required | Description |
|---|---|---|---|
| `firstDeployed` | [Time](./k8s-io-apimachinery-pkg-apis-meta-v1.md#Time) | No | FirstDeployed is when the release was first deployed. |
| `lastDeployed` | [Time](./k8s-io-apimachinery-pkg-apis-meta-v1.md#Time) | No | LastDeployed is when the release was last deployed. |
| `deleted` | *[Time](./k8s-io-apimachinery-pkg-apis-meta-v1.md#Time) | No | Deleted tracks when this object was deleted. |
| `description` | string | No | Description is human-friendly "log entry" about this release. |
| `status` | string | No | Status is the current state of the release |
| `notes` | string | No | Contains the rendered templates/NOTES.txt if available |
